...
import 'package:foodOrder/shared/bloc_observer.dart';
import 'package:foodOrder/shared/constants/themes.dart';
import 'package:foodOrder/shared/network/local/cache_helper.dart';
import 'package:foodOrder/shared/network/remote/dioHelper.dart';
...
void main() async{
  ...
  final bool? isDark2=CacheHelper.getData(key: 'isDark');
  runApp(MyApp(isDark: isDark2,));
}
